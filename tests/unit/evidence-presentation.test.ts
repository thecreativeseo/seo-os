...
describe("formatting", () => {
  ...
  it("gives a percentage for counts and points for rates and ranks", () => {
    ...
    expect(change(120, 100, "integer")).toEqual({ text: "+20.0%", direction: "up" });
    expect(change(80, 100, "integer")).toEqual({ text: "-20.0%", direction: "down" });
